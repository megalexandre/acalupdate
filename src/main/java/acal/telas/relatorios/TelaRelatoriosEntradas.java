...
public class TelaRelatoriosEntradas extends javax.swing.JDialog {

    /**
     * Creates new form TelaRelatoriosEntradas
     */
    ...
    private void initComponents() {
        ...
        jPanel11Layout.setVerticalGroup(
            jPanel11Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(jCheckBoxFuncionario, javax.swing.GroupLayout.DEFAULT_SIZE, 43, Short.MAX_VALUE)
        );
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        new Thread() {
           ...
           if(jCheckBoxId.isSelected()){
            ...
            {
                valMenor =  " ( e.valor between " + jTextFieldValorMenor.getText()  ;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            Logger.getLogger(TelaRelatoriosEntradas.class.getName()).log(Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                TelaRelatoriosEntradas dialog = new TelaRelatoriosEntradas(new javax.swing.JFrame(), true);
